...
namespace MyStringLib
{
	...
	bool ClientExistByAccountNumberInFile(string FileName, string AccountNumber)
	{
		fstream MyFile;
	...
	sClient ReadNewClient()
	{
		...
		while (ClientExistByAccountNumberInFile(ClientsFile, Client.AccountNumber))
		{
	...
	void PrintClientRecord(sClient Client)
	{
		...
		cout << "Account Balance: " << Client.AccoutBalance;
		cout << "\n-------------------------------------" << endl;
	}
