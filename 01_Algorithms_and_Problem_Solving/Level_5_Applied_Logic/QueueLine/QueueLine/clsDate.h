...
public:
	...
	static string FormatDate(clsDate Date, string DateFormat = "dd/mm/yyyy")
	{
		...
		FormattedString = clsString::ReplaceWordInString(DateFormat, "dd", to_string(Date._Day));
		FormattedString = clsString::ReplaceWordInString(FormattedString, "mm", to_string(Date._Month));
		FormattedString = clsString::ReplaceWordInString(FormattedString, "yyyy", to_string(Date._Year));
