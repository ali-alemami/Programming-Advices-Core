...
public:
	...
	static string FormatDate(clsDate Date, string DateFormat = "dd/mm/yyyy")
	{
		...
		FormattedString = clsString::ReplaceWord2(DateFormat, "dd", to_string(Date._Day));
		FormattedString = clsString::ReplaceWord2(FormattedString, "mm", to_string(Date._Month));
		FormattedString = clsString::ReplaceWord2(FormattedString, "yyyy", to_string(Date._Year));
