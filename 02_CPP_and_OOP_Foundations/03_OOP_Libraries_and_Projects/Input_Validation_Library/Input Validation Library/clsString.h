...
public:
	...
	static string ReplaceWord(string S1, string OldWord, string NewWord, string delim, bool MatchCase = true)
	{
	...
	void ReplaceWord(string OldWord, string NewWord, string delim, bool MatchCase = true)
	{
		//return ReplaceWord(_value, OldWord, NewWord, delim, MatchCase);
		_value = ReplaceWord(_value, OldWord, NewWord, delim, MatchCase);
	}

	static std::string ReplaceWord2(const std::string& str, const std::string& oldWord, const std::string& newWord) {
